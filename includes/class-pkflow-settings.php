...
class PKFLOW_Settings {
	...
	public function render_settings_page() {
		...
		<div class="wrap pkflow-admin-wrap">
			...
			<div class="pkflow-debug-banner" role="status" aria-live="polite">
				<strong><?php esc_html_e( 'PKFLOW Notice Debug', 'passkeyflow' ); ?></strong>
			...
			<div class="pkflow-premium-shell">
				<header class="pkflow-hero">
					<div class="pkflow-hero__content">
						<div class="pkflow-product-mark">
							...
							<div>
								<p class="pkflow-eyebrow"><?php esc_html_e( 'Welcome to', 'passkeyflow' ); ?></p>
				...
				<nav class="pkflow-tabs" aria-label="<?php esc_attr_e( 'PasskeyFlow for Secure Login settings tabs', 'passkeyflow' ); ?>">
				...
				<div class="pkflow-layout<?php echo 'dashboard' === $active_tab ? ' pkflow-layout--dashboard' : ''; ?>">
						...
						<?php else : ?>
							<form method="post" action="options.php" class="pkflow-settings-form">
								...
								<footer class="pkflow-form-footer">
									...
									<?php submit_button( __( 'Save Settings', 'passkeyflow' ), 'primary pkflow-save-button', 'submit', false ); ?>
								</footer>
							</form>
						<?php endif; ?>
					</main>
					...
					<?php if ( 'dashboard' !== $active_tab ) : ?>
					<aside class="pkflow-sidebar" aria-label="<?php esc_attr_e( 'PasskeyFlow for Secure Login quick actions', 'passkeyflow' ); ?>">
	...
	private function render_settings_tab() {
		...
		<section class="pkflow-section-header">
			<div>
				<p class="pkflow-eyebrow"><?php esc_html_e( 'Settings', 'passkeyflow' ); ?></p>
				<h2><?php esc_html_e( 'Everyday passkey controls', 'passkeyflow' ); ?></h2>
			</div>
			<span class="pkflow-badge"><?php esc_html_e( 'Recommended defaults', 'passkeyflow' ); ?></span>
		</section>
		...
		<div class="pkflow-card pkflow-grid-2">
			...
			<div class="pkflow-field">
				<div class="pkflow-label-row">
					...
					<span class="pkflow-badge pkflow-badge--success"><?php esc_html_e( 'Recommended', 'passkeyflow' ); ?></span>
				</div>
	...
	private function get_combined_audit_login_rows( int $limit, int $offset = 0 ): array {
		...
		return $wpdb->get_results( $sql, ARRAY_A ); // phpcs:ignore PluginCheck.Security.DirectDB.UnescapedDBParameter,WordPress.DB.DirectDatabaseQuery,WordPress.DB.PreparedSQL.NotPrepared -- dynamic query built only from prepared fragments and validated table identifiers.
	}
	...
	private function render_advanced_tab() {
		...
		<section class="pkflow-section-header">
			<div>
				<p class="pkflow-eyebrow"><?php esc_html_e( 'Advanced', 'passkeyflow' ); ?></p>
		...
		<div class="pkflow-card">
			<div class="pkflow-card__header">
				...
				<span class="pkflow-badge"><?php esc_html_e( 'Seconds', 'passkeyflow' ); ?></span>
			</div>
		...
		<div class="pkflow-card">
			<div class="pkflow-card__header">
				...
				<span class="pkflow-badge pkflow-badge--success"><?php esc_html_e( 'Protected', 'passkeyflow' ); ?></span>
			</div>
	...
	private function render_shortcodes_tab() {
		...
		<section class="pkflow-section-header">
			<div>
				<p class="pkflow-eyebrow"><?php esc_html_e( 'Shortcodes', 'passkeyflow' ); ?></p>
				<h2><?php esc_html_e( 'Drop-in passkey experiences', 'passkeyflow' ); ?></h2>
				<p class="pkflow-shortcode-tab-note"><?php esc_html_e( 'Prefer visual editing? Use matching Gutenberg blocks for login, registration, profile prompts, and active integrations or drop in shortcodes wherever you need them.', 'passkeyflow' ); ?></p>
			</div>
		</section>
		...
		<article class="pkflow-shortcode-helper-card" aria-label="<?php esc_attr_e( 'Shortcode quick start guide', 'passkeyflow' ); ?>">
	...
	private function render_shell_footer() {
		?>
		<footer class="pkflow-shell-footer" aria-label="<?php esc_attr_e( 'Maintainer links', 'passkeyflow' ); ?>">
			<span class="pkflow-shell-footer__label"><?php esc_html_e( 'Maintained by mbuiux', 'passkeyflow' ); ?></span>
			...
			<a class="pkflow-shell-footer__link" href="https://github.com/mbuiux/passkeyflow.git" target="_blank" rel="noopener noreferrer">
				<span class="pkflow-shell-footer__icon" aria-hidden="true">
