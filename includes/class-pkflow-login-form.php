...
class PKFLOW_Login_Form {
	...
	public function store_redirect_cookie(): void {
		...
		$redirect_raw = wp_unslash( $_GET['redirect_to'] ); // phpcs:ignore WordPress.Security.NonceVerification.Recommended,WordPress.Security.ValidatedSanitizedInput.InputNotSanitized -- read-only redirect hint; sanitized via esc_url_raw/wp_validate_redirect.
